...
public final class VideoPlayerView extends BaseView {
    ...
    private boolean verticalFullClickJustLandFull = true;
    ...
    private void intiClickView() {
        if (playerView.findViewById(com.google.android.exoplayer2.ui.R.id.exo_player_replay_btn_id) != null) {
            playerView.findViewById(com.google.android.exoplayer2.ui.R.id.exo_player_replay_btn_id).setOnClickListener(onClickListener);
        }
        if (playerView.findViewById(com.google.android.exoplayer2.ui.R.id.exo_player_error_btn_id) != null) {
            playerView.findViewById(com.google.android.exoplayer2.ui.R.id.exo_player_error_btn_id).setOnClickListener(onClickListener);
        }
        if (playerView.findViewById(com.google.android.exoplayer2.ui.R.id.exo_player_btn_hint_btn_id) != null) {
            playerView.findViewById(com.google.android.exoplayer2.ui.R.id.exo_player_btn_hint_btn_id).setOnClickListener(onClickListener);
        }
        getSwitchText().setOnClickListener(onClickListener);
        exoControlsBack.setOnClickListener(onClickListener);
        playerView.findViewById(com.google.android.exoplayer2.ui.R.id.exo_video_fullscreen).setOnClickListener(onClickListener);
    ...
    public void showFullscreenTempView(int visibility) {
        AppCompatCheckBox compatCheckBox = playerView.findViewById(com.google.android.exoplayer2.ui.R.id.sexo_video_fullscreen);
...
//                    showLockState(VISIBLE);
    ...
    public void enterFullScreen() {
        if (isNowVerticalFullScreen) {
            verticalFullScreen();
            if (verticalFullClickJustLandFull) {
                playerView.postDelayed(() -> {
                    if (!isNowVerticalFullScreen && VideoPlayUtils.getOrientation(getContext()) == Configuration.ORIENTATION_PORTRAIT) {
                        enterFullScreen();
                    }
                }, 400);
            }
    ...
    private View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (v.getId() == com.google.android.exoplayer2.ui.R.id.exo_video_fullscreen || v.getId() == com.google.android.exoplayer2.ui.R.id.sexo_video_fullscreen) {
                enterFullScreen();
            } else if (v.getId() == com.google.android.exoplayer2.ui.R.id.exo_controls_back) {
                activity.onBackPressed();
            } else if (v.getId() == com.google.android.exoplayer2.ui.R.id.exo_player_error_btn_id) {
                if (VideoPlayUtils.isNetworkAvailable(getContext())) {
                    ...
                    Toast.makeText(getContext(), com.google.android.exoplayer2.ui.R.string.net_network_no_hint, Toast.LENGTH_SHORT).show();
                }
            } else if (v.getId() == com.google.android.exoplayer2.ui.R.id.exo_player_replay_btn_id) {
                if (VideoPlayUtils.isNetworkAvailable(getContext())) {
                ...
                //切换
            } else if (v.getId() == com.google.android.exoplayer2.ui.R.id.exo_video_switch) {
                if (belowView == null) {
                ...
                //提示播放
            } else if (v.getId() == com.google.android.exoplayer2.ui.R.id.exo_player_btn_hint_btn_id) {
    ...
    public void setVerticalFullClickJustLandFull(boolean verticalFullClickJustLandFull) {
        this.verticalFullClickJustLandFull = verticalFullClickJustLandFull;
    }
