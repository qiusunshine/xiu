...
public class LockControlView extends FrameLayout implements View.OnClickListener, AnimUtils.AnimatorListener {
    ...
    public LockControlView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, @NonNull final BaseView baseView) {
        ...
        lockCheckBox = exoPlayLockLayout.findViewById(com.google.android.exoplayer2.ui.R.id.exo_player_lock_btn_id);
        exoControllerRight = baseView.getPlaybackControlView().findViewById(com.google.android.exoplayer2.ui.R.id.exo_controller_right);
        exoControllerLeft = baseView.getPlaybackControlView().findViewById(com.google.android.exoplayer2.ui.R.id.exo_controller_left);
