...
class BelowView {
    ...
    public BelowView(@NonNull Context c, @Nullable List<String> listName, int selectIndex) {
        ...
        if (listName == null) {
            listName = Arrays.asList(c.getResources().getStringArray(com.google.android.exoplayer2.ui.R.array.exo_video_switch_text));
        }
    ...
    public void showBelowView(@NonNull View view, boolean canceledOnTouchOutside, int selectIndex) {
        if (pw == null) {
            int height = (int) (view.getResources().getDimension(com.google.android.exoplayer2.ui.R.dimen.dp30) * adapter.getCount());
