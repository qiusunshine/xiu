...
public class ViewCollectionExtraData {
    ...
    private int jumpStartDuration = -1, jumpEndDuration = -1;
    ...
    public static String toJson(ViewCollectionExtraData extraData) {
    ...
    public static ViewCollectionExtraData fromJson(String extraDataString) {
        if (TextUtils.isEmpty(extraDataString)) {
            return new ViewCollectionExtraData();
        }
        ViewCollectionExtraData extraData = JSON.parseObject(extraDataString, ViewCollectionExtraData.class);
        if (extraData == null) {
            return new ViewCollectionExtraData();
        } else {
            return extraData;
