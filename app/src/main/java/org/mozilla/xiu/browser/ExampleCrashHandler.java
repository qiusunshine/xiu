...
public class ExampleCrashHandler extends Service {
  ...
  private static final String CHANNEL_ID = "xiu_crashes";
  ...
  private static final String ACTION_DISMISS = "org.mozilla.xiu.ACTION_DISMISS";
  ...
  public int onStartCommand(Intent intent, int flags, int startId) {
    ...
    if (GeckoRuntime.ACTION_CRASHED.equals(intent.getAction())) {
      ...
      try {
        CrashReporter.sendCrashReport(this, mCrashIntent, "Xiu");
      } catch (Exception e) {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
      NotificationChannel channel =
          new NotificationChannel(
              CHANNEL_ID, "APP Crashes", NotificationManager.IMPORTANCE_LOW);
