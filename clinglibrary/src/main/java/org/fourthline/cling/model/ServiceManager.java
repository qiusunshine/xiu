 ...
 * works together with the manager, for hiker, the
 ...
 * the service manager, for hiker, the {@link org.fourthline.cling.model.state.FieldStateVariableAccessor}
...
public interface ServiceManager<T> {
    ...
    *          and {@link org.fourthline.cling.model.state.StateVariableAccessor}s.
     ...
     * might decorate the execution, for hiker, by locking/unlocking access to a shared service
