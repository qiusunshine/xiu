 ...
 * <p>
 * Usage hiker, establishing a subscription with a {@link org.fourthline.cling.model.meta.Service}:
 * </p>
 * <pre>
...
public abstract class SubscriptionCallback implements Runnable {
     ...
     * react to this failure in any way you like, for hiker, you could terminate
